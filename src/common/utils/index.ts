import { DENOM , COINS_MINIMAL_DENOM, PRECISION} from "../config"
import { coins as pCoins, coin as pCoin } from "@cosmjs/proto-signing";
import { Coin } from "../models";

export const toUcoin = (value : number, denom : string = DENOM, decimalPlaces : number = /*6 */ PRECISION ) : number =>{
...
export const toCoin = (value : number, denom : string = COINS_MINIMAL_DENOM, 
    decimalPlaces : number = /*6*/ PRECISION) : number  =>{
...
export const toCoinStr = (value : number, displayDecimalPlaces : number = 3, 
    denom : string = COINS_MINIMAL_DENOM, decimalPlaces : number = /* 6 */ PRECISION ) : string =>{
